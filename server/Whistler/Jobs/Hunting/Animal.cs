...
namespace Whistler.Jobs.Hunting
{
    internal class Animal
    {
        ...
        public Animal(HuntingGround huntingGround, List<Player> clients)
        {
            ID = LastAnimalId++;
        ...
        private void UnloadForPlayer(Player player)
        {
        ...
        private void SetNewController()
        {
            ...
            if (client != null)
            {
                ...
                client.TriggerEvent("hunting:setController", ID);
            }
        }
        ...
        private void HandleHaut(PlayerGo player, int animalId)
        {
            try
            {
        ...
        private void HandleDecreaseHp(int animalId, int hpToTake)
        {
            ...
            if (HP <= 0)
            {
                _controller.TriggerEvent("hunting:handleAnimalDeath", ID);
            }
        }
        ...
        private void HandleSetPosition(int animalId, Vector3 newCoords)
        {
            ...
            Trigger.ClientEventToPlayers(_clients.ToArray(), "hunting:setAnimalPosition", ID, newCoords);
        }
        ...
        private void HandleUpdateState(int animalId, int newState)
        {
            ...
            Trigger.ClientEventToPlayers(_clients.ToArray(), "hunting:setState", ID, newState);
        }
        ...
        private void HandleUpdate(int animalId, Vector3 newCoords)
        {
            ...
            Trigger.ClientEventToPlayers(_clients.ToArray(), "hunting:updateAnimal", ID, newCoords);
        }
