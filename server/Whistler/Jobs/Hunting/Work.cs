...
namespace Whistler.Jobs.Hunting
{
    ...
    internal partial class Work : Script
    {
        ...
        public static event Action<PlayerGo, int> AnimalHautByPlayer;
        ...
        public static HuntingGround GetHuntingGroundWithPlayer(PlayerGo player)
        {
        ...
        public void PlayerDisconnectedHandler(PlayerGo player, DisconnectionType type, string reason)
        {
            try
            {
        ...
        public void HautAnimal(PlayerGo player, int animalId)
        {
            try
            {
        ...
        public void DecreaseHpHandler(PlayerGo player, int animalId, int hpToTakeAway)
        {
            try
            {
        ...
        public void ShootAnimalHandler(PlayerGo player, int animalId, float x, float y, float z)
        {
            try
            {
        ...
        public void SetAnimalPositionHandler(PlayerGo player, int animalId, float x, float y, float z)
        {
            try
            {
        ...
        public void UpdateAnimalHandler(PlayerGo player, int animalId, float x, float y, float z)
        {
            try
            {
        ...
        public void UpdateAnimalStateHandler(PlayerGo player, int animalId, int newState)
        {
            try
            {
