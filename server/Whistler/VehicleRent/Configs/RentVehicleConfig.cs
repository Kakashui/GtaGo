        ...
        {
            {
                RentSection.Car, new CategoryModel("car", "vehicleRent_6", _allColors,
                    new List<RentModel>
                    {
                        ...
                        new RentModel("patriot2", 15000),
                        new RentModel("ruston", 15000),
                        new RentModel("stretch", 15000),
                        new RentModel("toros", 20000),
                        new RentModel("turismo2", 25000),


                        new RentModel("italigtb", 30000),
                        new RentModel("tezeract", 50000),
                        new RentModel("zorrusso", 30000),
                    })
            },
            {
