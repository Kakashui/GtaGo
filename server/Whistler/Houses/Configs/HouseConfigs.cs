...
namespace Whistler.Houses.Configs
{
    class HouseConfigs
    {
        public static Dictionary<int, GarageType> GarageTypes = new Dictionary<int, GarageType>()
        {
            ...
            { 1, new GarageType(GarageCoordType.TwoPlace, GarageIPLType.NoIPL, 2, 100000, "house:garage:type:two".Translate(2))},
            { 2, new GarageType(GarageCoordType.FivePlace, GarageIPLType.NoIPL, 3, 200000, "house:garage:type:two".Translate(3))},
            { 3, new GarageType(GarageCoordType.FivePlace, GarageIPLType.NoIPL, 4, 400000, "house:garage:type:two".Translate(4))},
            { 4, new GarageType(GarageCoordType.FivePlace, GarageIPLType.NoIPL, 5, 800000, "house:garage:type".Translate(5))},
            { 5, new GarageType(GarageCoordType.TenPlace, GarageIPLType.NoIPL, 6, 1000000, "house:garage:type".Translate(6))},
            { 6, new GarageType(GarageCoordType.TenPlace, GarageIPLType.NoIPL, 10, 3000000, "house:garage:type".Translate(10))},
            ...
            { 15, new GarageType(GarageCoordType.G52Place, GarageIPLType.NoIPL, 52, 50000000, "house:garage:type:elite".Translate(52))},
            { 16, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle1, 12, 5000000, "house:garage:type:tuner".Translate(1))},
            { 17, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle2, 12, 5000000, "house:garage:type:tuner".Translate(2))},
            { 18, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle3, 12, 5000000, "house:garage:type:tuner".Translate(3))},
            { 19, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle4, 12, 5000000, "house:garage:type:tuner".Translate(4))},
            { 20, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle5, 12, 5000000, "house:garage:type:tuner".Translate(5))},
            { 21, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle6, 12, 5000000, "house:garage:type:tuner".Translate(6))},
            { 22, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle7, 12, 5000000, "house:garage:type:tuner".Translate(7))},
            { 23, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle8, 12, 5000000, "house:garage:type:tuner".Translate(8))},
            { 24, new GarageType(GarageCoordType.TunerGarage, GarageIPLType.TunerGarageStyle9, 12, 5000000, "house:garage:type:tuner".Translate(9))},
        };
