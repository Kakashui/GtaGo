...
namespace Whistler.Houses
{
    class GarageManager : Script
    {
        ...
        public static void OnLoadGarages()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    if (HouseManager.GetHouseByGarageId(id) == null)
                    {
        ...
        private static void GoToCoord(Player player, Vector3 pos, Vector3 rot)
        {
        ...
        public static void ExitGarage(PlayerGo player)
        {
        ...
        public static void ExitGarageIntoVehicle(PlayerGo player)
        {
            if (player.Character.InsideGarageID == -1) return;
            var garage = Garages[player.Character.InsideGarageID];
        ...
        public static void SendVehicleIntoGarage(VehicleBase vehData)
        {
            ...
            WhistlerTask.Run(() => {
                ...
                {
                    if ((vehData as PersonalBaseVehicle).TradePoint > 0)
                    {
                        TradeManager.SpawnTradeCar(vehData as PersonalBaseVehicle);
                        return;
                    }
                }
        ...
        #region Commands
        [Command("setgarage")]
        public static void CMD_SetGarage(PlayerGo player, int ID)
        {
        ...
        public static void CMD_CreateGarage(Player player, int houseId, int type)
        {
