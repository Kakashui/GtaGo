...
namespace Whistler.PersonalEvents.Contracts.Models
{
    class ContractModel
    {
        ...
        private bool EnterPredicate(ColShape shape, PlayerGo player)
        {
            return GetContractProgress(player)?.InProgress ?? false;
        }

        public ContractProgress GetContractProgress(PlayerGo player)
        {
            return GetContractInfo(player)?.ContractList.GetValueOrDefault(ContractName);
        }

        public ContractInfo GetContractInfo(PlayerGo player)
        {
            switch (ContractType)
            {
        ...
        public void AcceptContract(PlayerGo player)
        {
        ...
        public int ContractProgressed(PlayerGo player, int count)
        {
