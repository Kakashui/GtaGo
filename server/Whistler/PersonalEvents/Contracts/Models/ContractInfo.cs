...
namespace Whistler.PersonalEvents.Contracts.Models
{
    class ContractInfo
    {
        ...
        public bool AcceptContract(PlayerGo player, ContractModel contractModel)
        {
        ...
        public void UpdateContract(PlayerGo player, ContractNames contractName, ContractTypes contractType)
        {
            ...
            switch (contractType)
            {
                case ContractTypes.Single:
                    player.TriggerEvent("personalEvents:updateMyContracts", JsonConvert.SerializeObject(ContractList[contractName].GetDTO(contractName)));
                    break;
        ...
        public int AddProgress(PlayerGo player, ContractModel contractModel, int count)
        {
            if (!ContractList.ContainsKey(contractModel.ContractName))
                return 0;
        ...
        public void CompleteContract(PlayerGo player, ContractModel contractModel)
        {
            if (!ContractList.ContainsKey(contractModel.ContractName))
                return;
