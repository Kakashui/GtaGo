...
namespace Whistler.PersonalEvents.Models
{
    class EventModel
    {
        ...
        public AchieveProgress AchieveProgress(PlayerGo player, AchieveParams achieveParams, int progress)
        {
        ...
        public AchieveProgress GiveReward(PlayerGo player, AchieveParams achieveParams)
        {
