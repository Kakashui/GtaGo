...
namespace Whistler.PersonalEvents.Achievements
{
    class AchieveSettings : Script
    {
        public AchieveSettings()
        {
            ...
            {
                using (var w = new StreamWriter("Client/src/client/personalEvents/configs/achievesConfig.js"))
                {
                    w.Write($"module.exports = {JsonConvert.SerializeObject(AchievesSettings.Values)}");
                }
                using (var w = new StreamWriter("Client/src/client/personalEvents/configs/playerActionSyncParams.js"))
                {
