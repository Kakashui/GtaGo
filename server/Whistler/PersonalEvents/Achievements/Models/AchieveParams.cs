...
namespace Whistler.PersonalEvents.Achievements.Models
{
    class AchieveParams
    {
        ...
        public void AchieveProgress(PlayerGo player, int progress)
        {
        ...
        public void GiveReward(PlayerGo player)
        {
        ...
        public void UpdateAchieve(PlayerGo player, AchieveProgress achieve)
        {
            player.TriggerEvent("personalEvents:updateAchieve", JsonConvert.SerializeObject(new AchieveProgressDTO(achieve, AchieveName)));
        }
    }
}
