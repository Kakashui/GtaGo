...
namespace ServerGo.Casino.Games.Poker
{
    internal class PokerPlayer
    {
        ...
        [JsonIgnore]
        public Player _client;
        public PokerPlayer(Player player, Gambler gambler, int place, int minBalance)
        {
            ...
            allIn = false;
            Image = player.GetCharacter().ImageLink;
        }
        ...
        {
            Trigger.ClientEvent(_client, "poker:requestMakingBet", currentBet, myBet);
        }
