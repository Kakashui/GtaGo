...
namespace Whistler.Fractions
{
    class AlcoFabrication //: Script
    {
        ...
        */
        ...
        //private static void EnterClub(Player player, int club)
        //{
        //    player.ChangePosition(ExitAlcoShop[club] + new Vector3(0, 0, 1.2));
        //}

        //private static void ExitClub(Player player, int club)
        //{
        //    player.ChangePosition(EnterAlcoShop[club] + new Vector3(0, 0, 1.2));
        //}

        //private static void InteractStock(Player player)
        //{
        //    if (!player.IsLogged()) return;

        //    if (player.GetCharacter().FractionID != player.GetData<string>("CLUB"))
        //    {
        ...
        //private static void InteractBuy(Player player)
        //{
        //    if (!player.IsLogged()) return;
        ...
        //    }
        //    else
        //        player.SetData("RESIST_TIME", player.GetData<string>("RESIST_TIME") - 1);
        //}
        ...
        //{
        //    int club = player.GetData<string>("CLUB");
        //    var isOwner = player.GetCharacter().FractionID == club;
        ...
        //public static void RemoteEvent_BuyDrink(Player player, int drinkIndex)
        //{
        //    try
        //    {
        ...
        //        GameLog.Money($"player({player.GetCharacter().UUID})", $"frac({club})", Convert.ToInt32(DrinksPrices[drinkIndex] * ClubsStocks[club].PriceModifier), $"buyAlco");
        ...
        //public static void RemoteEvent_TakeDrink(Player player, int drinkIndex)
        //{
        //    try
        //    {
        //        if (player.GetData<string>("CLUB") == -1) return;
        ...
        //        if (player.GetCharacter().FractionID != club || !Manager.canUseCommand(player, "takeclubalco", false))
        //        {
        ...
        //public static void RemoteEvent_SetDrinkPrice(Player player, int drinkIndex, int newPrice)
        //{
        //    try
        //    {
        //        if (player.GetData<string>("CLUB") == -1) return;
        ...
        //        if (player.GetCharacter().FractionID != club || !Manager.canUseCommand(player, "setalcoprice", false))
        //        {
        ...
        //        ClubsStocks[player.GetCharacter().FractionID].PriceModifier = newPrice / 100.0f;
        ...
        //public static void RemoteEvent_CraftDrink(Player player, int drinkIndex)
        //{
        //    try
        //    {
        //        if (player.GetData<string>("CLUB") == -1) return;
        ...
        //        if (player.GetCharacter().FractionID != club || !Manager.canUseCommand(player, "craftalco", false))
        //        {
