...
namespace Whistler.Fractions
{
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(404, new Vector3(2832.932, -663.3395, 0), 1, 69, shortRange: true);
                NAPI.Blip.CreateBlip(455, new Vector3(3098.926, -4795.587, 2.184744), 1, 69, shortRange: true);
        ...
        private static void OpenArmyclothes(Player player)
        {
        ...
        private static void UseLiftByPlayer(Player player)
        {
