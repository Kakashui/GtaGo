...
namespace Whistler.Fractions
{
    class Police : Script
    {
        ...
        public static void callPolice(Player player)
        {
            try
            {
        ...
        {
            if (player.GetCharacter().FractionID == 7)
        ...
        private void arrestShape_onEntityExitColShape(ColShape shape, Player player)
        {
            try
            {
                ...
                {
                    player.ChangePosition(Police.policeCheckpoints[4]);
                }
            }
        ...
        public static void onPlayerDisconnectedhandler(Player player, DisconnectionType type, string reason)
        {
            try
            {
                ...
                {
                    Player target = player.GetCharacter().Following;
                    target.GetCharacter().Follower = null;
                }
                else if (player.GetCharacter().Follower != null)
                {
                    Player target = player.GetCharacter().Follower;
                    target.GetCharacter().Following = null;
