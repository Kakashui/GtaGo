...
namespace Whistler.Fractions.SupplyManagers
{
    public class MaterialsSupply : Script
    {
        ...
        private class Container
        {
            ...
            private void GetMaterials(PlayerGo player)
            {
                ...
                var box = SupplyConfig.GetRandomTypeBox(boxType);
                if (box == null)
                    return;
                ...
                Wallet.MoneyAdd(player.GetCharacter(), MoneyPerHandContainer, "Money_MatSupply");
                ...
                player.SetData("gunsupplynextbox", DateTime.Now.AddSeconds(_nextBoxReload));
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, boxType == ItemNames.WeaponBox ? "matsupply_6" : "matsupply_7", 3000);
            }
        ...
        public void DropContainerHandler(PlayerGo player)
        {
            if (!player.IsLogged())
                return;
        ...
        public void RequestSupplyHandler(Player player)
        {
        ...
        public void RequestSupplyHandlerAdmin(Player player)
        {
        ...
        public void DeleteSupplyHandler(Player player)
        {
