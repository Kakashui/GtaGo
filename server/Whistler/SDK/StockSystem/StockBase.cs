...
namespace Whistler.SDK.StockSystem
{
    abstract class StockBase
    {
        ...
        public abstract void OpenStock(Player player);
        public abstract void ExitShape(ColShape shape, Player player);
        public abstract void ChangePassword(Player player);
        public abstract bool EnterPredicate(ColShape shape, Player player);
