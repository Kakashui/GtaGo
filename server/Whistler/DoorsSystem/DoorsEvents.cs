...
namespace Whistler.DoorsSystem
{
    class DoorsEvent: Script
    {
        ...
        [Command("parsedoors")]
        public void ParseDoor(Player player)
        {
        ...
        public void SetDoorState(Player player, int uuid, bool state)
        {
        ...
        public void AddDoorAccess(Player player, int uuid, string access)
        {
        ...
        public void CheckDoorAccess(Player player, int uuid)
        {
            if (!Group.CanUseAdminCommand(player, "dooraccess")) return;
