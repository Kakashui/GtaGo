...
namespace Whistler.MP.Arena.Racing
{
    internal class RacingManager : Script
    {
        ...
        private static void OnPlayerEnteredCheckpoint(Player player)
        {
            try
            {
        ...
        private static void OnPlayerFinished(PlayerGo player, int raceTimeInSeconds)
        {
            try
            {
        ...
        private static void OnPlayerLeaved(Player player)
        {
            try
            {
        ...
        public void PlayerDisconnectedHandler(Player player, DisconnectionType type, string reason)
        {
            try
            {
        ...
        public static void OnPlayerDeadOnRace(Player player)
        {
            try
            {
                DeletePlayerFromCurrentMap(player);
        ...
        public static void DeletePlayerFromCurrentMap(Player player)
        {
