...
namespace Whistler.MP.Arena.Racing
{
    public class RacingMap
    {
        ...
        public Dictionary<Player, Racer> Players => _players.ToDictionary(key => key.Player);
        ...
        private void StartRace()
        {
            ...
            _players.ForEach(p=>
            {
                ...
                p.Player.TriggerEvent("arena:tracking:start", 
        ...
        public void RegisterPlayer(Player player)
        {
            ...
            if (!Wallet.MoneySub(player.GetCharacter(), RacingSettings.RegistrationPayment, "Money_Registration"))
            {
        ...
        public void OnPlayerFinished(PlayerGo player)
        {
            ...
            Wallet.MoneyAdd(player.GetCharacter(), Convert.ToInt32(winning * BestTimeRewardMultiplier), "Money_RacingWinning");
