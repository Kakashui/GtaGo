...
namespace Whistler.MP.Arena.Lobbies
{
    internal static class LobbyManager
    {
        ...
        private static void StartLobby(PlayerGo starter, IArenaLobby lobby)
        {
        ...
        private static void KickFromLobby(PlayerGo owner, string victimname, IArenaLobby lobby)
        {
            ...
            LeaveLobby(victimClient as PlayerGo, lobby);
        }

        public static void LeaveLobby(PlayerGo leaver, IArenaLobby lobby)
        {
        ...
        private static void JoinToLobby(PlayerGo joiner, IArenaLobby lobby, TeamName team)
        {
        ...
        public static void CreateStrikeLobby(PlayerGo creator, StrikeLobbySettings settings)
        {
            ...
            if (!Wallet.MoneySub(creator.GetCharacter(), settings.EntryBet, "Money_Entrybet"))
            {
