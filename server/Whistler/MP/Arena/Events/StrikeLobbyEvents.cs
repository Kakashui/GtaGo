...
namespace Whistler.MP.Arena.Events
{
    ...
    internal delegate void LocationChangeVoteHandler(PlayerGo voter, string mapName);
    ...
    internal delegate void LobbyCreateHandler(PlayerGo creator, StrikeLobbySettings settings);
    ...
    internal delegate void LobbyJoinHandler(PlayerGo joiner, IArenaLobby lobby, TeamName team);
    ...
    internal delegate void LobbyStartHandler(PlayerGo starter, IArenaLobby lobby);
    ...
    /// <param name="lobby">Лобби</param>
    internal delegate void LobbyLeaveHandler(PlayerGo leaver, IArenaLobby lobby);
    ...
    /// <param name="lobby">Лобби</param>
    internal delegate void LobbyKickHandler(PlayerGo leaver, string victimName, IArenaLobby lobby);
    ...
    internal class StrikeLobbyEvents : Script
    {
        ...
        public void OnMapVoteChanged(PlayerGo player, string mapName)
        {
            try
            {
        ...
        public void OnLobbyAdded(PlayerGo player, string mode, string map, int maxPlayers, string weapon, int rounds, int bet)
        {
            try
            {
        ...
        public void OnLobbyJoined(PlayerGo player, string teamName, int lobbyId)
        {
            try
            {
        ...
        public void OnLobbyStarted(PlayerGo player, int lobbyId)
        {
            try
            {
                // Если лобби есть на сервере
        ...
        public void OnLobbyLeaved(PlayerGo player, int lobbyId)
        {
            try
            {
                // Если лобби есть на сервере
        ...
        public void OnLobbyKicked(PlayerGo player, string victimName, int lobbyId)
        {
            try
            {
                // Если лобби есть на сервере
        ...
        public void OnArenaMenuClosed(PlayerGo player)
        {
            try
            {
