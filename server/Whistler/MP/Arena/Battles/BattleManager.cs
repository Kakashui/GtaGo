...
namespace Whistler.MP.Arena.Battles
{
    internal class BattleManager : Script
    {
        ...
        public static void OnPlayerDead(Player victim, Player killer, uint reason)
        {
            try
            {
        ...
        public static IArenaBattle GetPlayerBattle(Player player, out IBattleMember member)
        {
