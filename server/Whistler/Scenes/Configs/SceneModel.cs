...
namespace Whistler.Scenes.Configs
{
    class SceneModel
    {
        ...
        public void InvokeSequenceCallback(PlayerGo player)
        {
        ...
        [JsonIgnore]
        public Action<PlayerGo> ActionOnStart { get; private set; }
        [JsonIgnore]
        public Action<PlayerGo> ActionOnFinish { get; private set; }
        ...
        public SceneModel AddActionOnStart(Action<PlayerGo> action)
        {
            ActionOnStart = action;
            return this;
        }

        public SceneModel AddActionOnFinish(Action<PlayerGo> action)
        {
        ...
        public void InvokeActionCallback(PlayerGo player)
        {
