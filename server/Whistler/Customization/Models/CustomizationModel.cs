...
namespace Whistler.Customization.Models
{
    public class CustomizationModel
    {
        ...
        public void SetMaskFace(Player player, bool state)
        {
            if (state)
            {
        ...
        private void UpdateHeadBlendData(Player player)
        {
            player.HeadBlend = HeadBlend;
        }
        private void UpdateHeadOverlays(Player player)
        {
        ...
        private void UpdateFaceFeatures(Player player)
        {
        ...
        internal void UpdateHairsModel(Player player, int style, int color1, int color2)
        {
            Hairs.Id = style;
        ...
        internal void EditHeadOverlay(Player player, int v, int style, int color)
        {
        ...
        private void UpdateGender(Player player)
        {
        ...
        public void UpdateTattoos(Player player)
        {
            ...
            player.TriggerEvent("tattoo:list:update", Tattoos);
        }
    }
}
