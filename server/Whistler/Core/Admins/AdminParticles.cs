...
namespace Whistler.Core.Admins
{
    public class AdminParticles : Script
    {
        ...
        [Command("apfx")]
        public void SetAdminAppearanceEffect(Player player, string effectName)
        {
            try
            {
        ...
        public static void PlayAdminAppearanceEffect(Player player, float zPosition = default)
        {
