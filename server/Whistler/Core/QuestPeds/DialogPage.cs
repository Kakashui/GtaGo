...
namespace Whistler.Core.QuestPeds
{
    ...
    internal class DialogPage
    {
        ...
        public event Action<PlayerGo> OpenedForPlayer;
        public static Dictionary<PlayerGo, DialogPage> OpenedPages = new Dictionary<PlayerGo, DialogPage>();
        ...
        public DialogPage AddAnswer(string answerText, Action<PlayerGo> callback)
        {
        ...
        public DialogPage AddCloseAnswer(string answerText = "QuestDialog_0")
        {
        ...
        internal void OnPlayerClosedDialog(PlayerGo player)
        {
        ...
        public DialogPage AddAnswer(string answerText, DialogPage pageToRedirect)
        {
            ...
            {
                //p.TriggerEvent("questPeds:setDataDialog", pageToRedirect.GetSerializedData());
                CloseForPlayer(p);
        ...
        public void OpenForPlayer(PlayerGo player)
        {
            ...
            player.TriggerEvent("questPeds:openDialog", GetSerializedData());
        }
        
        public void CloseForPlayer(PlayerGo player, bool fullClose = false)
        {
            if (OpenedPages.ContainsKey(player))
            {
                OpenedPages.Remove(player);
                player.TriggerEvent("questPeds:closeDialog", fullClose);
            }
        }

        public void OnPlayerSelectedAnswer(PlayerGo player, int answerId)
        {
