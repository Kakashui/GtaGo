    ...
    internal class Lifts : Script
    {
        ...
        public void CreateGhettoMallLift()
        {
            GUI.Lifts.Lift.Create()
                .AddFloor("lift_floor1", GhettoMallFloor1, marker: false)
                .AddFloor("lift_floor2", GhettoMallFloor2, marker: false)
                .AddFloor("lift_floor3", GhettoMallFloor3, marker: false);
        }
