...
{
    internal delegate void PetHandler(int petId, Player player);
    ...
    internal class PetsManager : Script
    {
        ...
        public void LoadPetForPlayer(Player player, int petId)
        {
            try
            {
        ...
        public void UnloadPetForPlayer(Player player, int petId)
        {
            try
            {
        ...
        public void MovePetPosition(Player player, int petId, float x, float y, float z, float speed)
        {
            try
            {
        ...
        public void SetPetPosition(Player player, int petId, float x, float y, float z)
        {
            try
            {
        ...
        public void SyncPetState(Player player, int petId, int newState)
        {
            try
            {
        ...
        public void DestoryPet(Player player)
        {
            try
            {
        ...
        private void UsePet(PlayerGo player, Animal item)
        {
            if (item.IsActive)
            {
                UnloadPlayerPet(player);
        ...
        private void UnloadPlayerPet(Player player)
        {
            try
            {
        ...
        public static void SpawnPet(Player owner, int petModel)
        {
