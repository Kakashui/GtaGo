        ...
        public PhoneMapperProfile()
        {
            ...
            CreateMap<MsgContact, MsgContactDto>()
                ...
                .AfterMap((source, dto) =>
                {
                    ...
                    dto.IsOnline = Main.GetPlayerGoByPredicate(player => (player.Character.PhoneTemporary?.Account?.Id ?? 0) == source.TargetAccountId) != null;
                });
            ...
            CreateMap<Account, FullAccountDto>()
                ...
                .AfterMap((source, dto) =>
                {
                    ...
                    dto.IsBlocked = false;
                    dto.IsMuted = false;
                    dto.IsOnline = Main.GetPlayerGoByPredicate(player => (player.Character.PhoneTemporary?.Account?.Id ?? 0) == source.Id) != null;
                });
