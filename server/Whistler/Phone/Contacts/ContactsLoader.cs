...
namespace Whistler.Phone.Contacts
{
    internal class ContactsLoader : Script
    {
        ...
        private async Task LoadPlayerContactsInfo(Player player, Character character)
        {
            try
            {
        ...
        private async Task LoadPlayerContacts(Player player, ServerContext context, Domain.Phone.Phone phone)
        {
        ...
        private async Task LoadPlayerBlocks(Player player, ServerContext context, Domain.Phone.Phone phone)
        {
