...
namespace Whistler.Families.FamilyWars
{
    class WarManager : Script
    {
        ...
        public static bool Event_PlayerDeath(PlayerGo player, PlayerGo Killer, uint weapon)
        {
            try
            {
                bool result = false;
        ...
        public static void SubscribeToBattleEvent(BattleLocation location, Action<Player, BattleLocation> actionEnter, Action<Player, BattleLocation> actionExit )
        {
        ...
        public static void UnsubscribeToBattleEvent(BattleLocation location, Action<Player, BattleLocation> actionEnter, Action<Player, BattleLocation> actionExit )
        {
            _warPoints[location].PlayerEnterBattleLocation -= actionEnter;
            _warPoints[location].PlayerExitBattleLocation -= actionExit;
            if (_warPoints[location].WarBlip != null)
