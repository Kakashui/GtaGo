...
namespace Whistler.Core
{
    ...
    {
        public static void OpenBurgerShot(Player player, int bizId)
        {
            ...
            {
                Money = (int)player.GetCharacter().Money,
        ...
        public static void HandleBurgerShotBuy(Player player, string json)
        {
            try
            {
        ...
        private static int GiveProductToInventory(Player player, string name, int count)
        {
