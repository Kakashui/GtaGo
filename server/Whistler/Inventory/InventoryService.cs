...
namespace Whistler.Inventory
{
    public static class InventoryService
    {
        ...
        public static Action<PlayerGo, BaseItem> OnUseItem;
        public static Action<PlayerGo, Animal> OnUseAnimal;
        public static Action<PlayerGo, Seed> OnUseSeed;
        public static Action<PlayerGo, ItemBox> OnUseItemBox;
        public static Action<PlayerGo, WateringCan> OnUseWateringCan;
        public static Action<PlayerGo, Fertilizer> OnUseFertilizer;
        public static Action<PlayerGo, VehicleKey> OnUseCarKey;
        public static Action<PlayerGo, Other> OnUseOtherItem;
        public static Action<PlayerGo, Food> OnUseFoodItem;
        public static Action<PlayerGo, Drink> OnUseDrinkItem;
        public static Action<PlayerGo, Alcohol> OnUseAlcoholeItem;
        public static Action<PlayerGo, Narcotic> OnUseNarcoticsItem;
        public static Action<PlayerGo, Medicaments> OnUseMedicaments;
        public static Action<PlayerGo, LifeActivityData> OnUseLifeActivityItem;
        ...
        internal static void OnPlayerSpawn(Player player)
        {
            player.TriggerEvent("weapon:damage:config:update", WeaponDamageConfigs);
            player.TriggerEvent("weapon:damage:coef:update", WeaponDamageModifiers);
        }
        ...
        {
            var data = MySQL.QueryRead("INSERT INTO `inventories`(`items`, `maxWeight`, `size`, `type`) VALUES(@prop0, @prop1, @prop2, @prop3); SELECT @@identity;",
        ...
        public static void ParseAttachWeapons()
        {
            ...
            using (var w = new StreamWriter("Client/src/client/WeaponSystem/weaponConfigs.js"))
            {
        ...
        public static void SyncInventoryId(this Player player)
        {
            var inventory = player.GetInventory();
            if (inventory == null) return;
            player.TriggerEvent("inv:set:personal", inventory.Id);
        }

        public static void SyncInventory(this Player player, int id)
        {
            try
            {
                var inventory = GetById(id);
                if (inventory == null) return;
                WhistlerTask.Run(() => { player.TriggerEvent("inv:set:byid", inventory.Id, inventory.GetInventoryData(), inventory.MaxWeight, inventory.Size); });
            }
            catch (Exception ex)
            {
        ...
        public static void OpenStock(Player player, int inventoryId, StockTypes type)
        {
            var inventory = GetById(inventoryId);
            if (inventory == null) return;
            inventory.Subscribe(player);
            DropSystem.Subscribe(player);
            player.TriggerEvent("inv:open:stock", inventoryId, (int)type);
        }
        ...
        public static void parseConfig()
        {
            ...
            {
                using (var w = new StreamWriter("Client/src/client/configs/costumes.js"))
                {
        ...
        internal static InventoryModel GetByUUID(int uuid)
        {
            ...
            if (characterInCache != null) return characterInCache.Inventory;

            var result = MySQL.QueryRead("SELECT `inventoryId` FROM `characters` WHERE `uuid`=@prop0", uuid);
