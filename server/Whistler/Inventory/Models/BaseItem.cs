...
namespace Whistler.Inventory.Models
{
    public abstract class BaseItem
    {
        ...
        public void CheckEffects(PlayerGo player, List<List<EffectModel>> effects)
        {
        ...
        public abstract bool Use(PlayerGo player);
        public abstract bool CanUse(PlayerGo player);
        public abstract bool Equip(PlayerGo player);
